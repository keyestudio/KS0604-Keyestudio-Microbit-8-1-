...
使用一些乐高积木块、Microbit V2主板，舵机扩展板和1个360°乐高舵机等，来搭建一个摩天轮，通过Microbit V2主板上面的按钮A/B和代码编程来控制摩天轮转动。
...
flowchart TD
    ...
    EventBtnA -->|是| BtnAAction[1\. SK6812 RGB LED亮彩色灯<br>2\. 5×5 LED点阵屏显示“高兴”图案<br>3\. 摩天轮转动]
    BtnAAction --> IdleState
    EventBtnB -->|否| IdleState
    EventBtnB -->|是| BtnBAction[1\. SK6812 RGB LED熄灭<br>2\. 5×5 LED点阵屏清屏<br>3\. 摩天轮停止转动]
...
② 按下micro:bit V2主板上面的按钮A且松开时，摩天轮开始转动，同时SK6812 RGB LED亮彩色灯，micro:bit V2主板上面的5×5 LED点阵屏显示图案![Img](./media/ab3.png)。

![Img](./media/cou19.png)

③ 按下micro:bit V2主板上面的按钮B且松开时，摩天轮停止转动，同时SK6812 RGB LED熄灭，micro:bit V2主板上面的5×5 LED点阵屏清屏。
