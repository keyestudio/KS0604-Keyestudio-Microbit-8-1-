...
使用一些乐高积木块、Microbit V2主板，舵机扩展板和1个乐高舵机等，来搭建一个声控摩天轮，通过Microbit V2主板上面的按钮A/B和代码编程来控制摩天轮转动。
...
flowchart TD
    ...
    EventBtnA --> BtnAAction[1\. SK6812 RGB LED亮彩色灯<br>2\. 5×5 LED点阵屏显示“高兴”图案<br>3\. 摩天轮转动]
    BtnAAction --> IdleState
    
    EventBtnB --> BtnBAction[1\. SK6812 RGB LED熄灭<br>2\. 5×5 LED点阵屏清屏<br>3\. 摩天轮停止转动]
