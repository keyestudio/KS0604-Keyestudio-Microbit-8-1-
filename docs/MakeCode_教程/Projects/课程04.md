...
单击下载代码: ![Img](./media/ABC12.png) [3_3_4_Electric_Crab](./Codes/3_3_4_Electric_Crab.hex)
...
使用在线浏览器下载示例代码，则需要将下载好的 “.hex” 文件发送到micro:bit主板上。如下两种方式：
...
按下micro:bit V2主板上面的按钮A且松开时，电动螃蟹向一个方向行走，同时SK6812 RGB LED亮红色灯，micro:bit V2主板上面的5×5 LED点阵屏显示图案![Img](./media/ab3.png)；

按下micro:bit V2主板上面的按钮B且松开时，电动螃蟹向相反方向行走，同时SK6812 RGB LED亮青色灯，micro:bit V2主板上面的5×5 LED点阵屏显示图案![Img](./media/ab4.png)；
