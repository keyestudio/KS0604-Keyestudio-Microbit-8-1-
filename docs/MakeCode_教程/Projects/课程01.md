...
**左边360°乐高舵机和右边360°乐高舵机的接线**

| 左边360°乐高舵机 | 舵机扩展板引脚(SERVO2/P2) | micro:bit V2主板引脚 |
| :-------------: | :----------------------: | :-----------------: |
|       棕线      |           GND            |           G         |
|       红线      |           VCC            |           V         |
|      橙黄线     |          SIG(S)          |           P2        |

| 右边360°乐高舵机 | 舵机扩展板引脚(SERVO1/P1) | micro:bit V2主板引脚 |
| :-------------: | :----------------------: | :-----------------: |
|       棕线      |           GND            |          G          |
|       红线      |           VCC            |          V          |
|      橙黄线     |          SIG(S)          |          P1         |
...
单击下载示例代码: ![Img](./media/ABC12.png) [3_3_1_Multifunctional_Car](./Codes/3_3_1_Multifunctional_Car.hex)
