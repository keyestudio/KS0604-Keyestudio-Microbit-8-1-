...
flowchart TD
    ...
    EventMouse -->|否| IdleState
    EventMouse -->|是| MouseAction[1\. SK6812 RGB LED亮红色灯<br>2\. 5×5 LED点阵屏显示“↑”图案<br>3\. 小车前进]
    MouseAction --> IdleState
    EventBtnAB -->|否| IdleState
    EventBtnAB -->|是| BtnABAction[1\. SK6812 RGB LED亮绿色灯<br>2\. 5×5 LED点阵屏显示“↓”图案<br>3\. 小车后退]
    BtnABAction --> IdleState 
    EventBtnA -->|是| BtnAAction[1\. SK6812 RGB LED亮青色灯<br>2\. 5×5 LED点阵屏显示“←”图案<br>3\. 小车右转]
    BtnAAction --> IdleState 
    EventBtnA -->|否| IdleState
    EventBtnB -->|是| BtnBAction[1\. SK6812 RGB LED亮洋红色灯<br>2\. 5×5 LED点阵屏显示“→”图案<br>3\. 小车左转]
    BtnBAction --> IdleState 
    EventScreenUp -->|否| IdleState
    EventScreenUp -->|是| ScreenUpAction[1\. SK6812 RGB LED熄灭<br>2\. 5×5 LED点阵屏清屏<br>3\. 小车停止]
```
