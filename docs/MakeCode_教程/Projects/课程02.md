...
使用一些乐高积木件、Microbit V2主板，舵机扩展板和乐高舵机等，来搭建一个摇摆小船，通过Microbit V2主板上面的按钮A/B和代码编程来控制摇摆小船向前滑动、向后滑动和停止滑动。
...
flowchart TD
    ...
    EventBtnA --> BtnAAction[1\. SK6812 RGB LED亮红色灯<br>2\. 5×5 LED点阵屏显示“高兴”图案<br>3\. 摇摆小船向前滑动]
    BtnAAction --> IdleState

    EventBtnB --> BtnBAction[1\. SK6812 RGB LED亮橙色灯<br>2\. 5×5 LED点阵屏显示“蝴蝶”图案<br>3\. 摇摆小船向后滑动]
...
2\. 设置micro:bit V2主板上面的5×5LED点阵屏显示图案.
