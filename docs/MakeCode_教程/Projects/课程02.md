...
flowchart TD
    ...
    IdleState --> EventBtnAB{按下micro:bit V2主板上面的按钮A+B且松开 ?} 
    EventBtnA -->|否| IdleState
    EventBtnA -->|是| BtnAAction[1\. SK6812 RGB LED亮红色灯<br>2\. 5×5 LED点阵屏显示“高兴”图案<br>3\. 摇摆小船向前滑动]
    BtnAAction --> IdleState
    EventBtnB -->|否| IdleState
    EventBtnB -->|是| BtnBAction[1\. SK6812 RGB LED亮橙色灯<br>2\. 5×5 LED点阵屏显示“蝴蝶”图案<br>3\. 摇摆小船向后滑动]
    BtnBAction --> IdleState
    EventBtnAB -->|否| IdleState
    EventBtnAB -->|是| BtnABAction[1\. SK6812 RGB LED熄灭<br>2\. 5×5LED点阵屏清屏<br>3\. 摇摆小船停止滑动]
