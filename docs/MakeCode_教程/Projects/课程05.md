...
flowchart TD
    ...
    EventBtnA -->|是| BtnAAction[1\. SK6812 RGB LED亮彩色灯<br>2\. 5×5 LED点阵屏显示 “高兴” 图案<br>3\. 飞轮车行走，飞轮也转起来]
    BtnAAction --> IdleState
    EventBtnB -->|否| IdleState
    EventBtnB -->|是| BtnBAction[1\. SK6812 RGB LED熄灭<br>2\. 5×5 LED点阵屏清屏<br>3\. 飞轮车停止，飞轮也停止]
...
② 按下micro:bit上面的按钮A且松开时，飞轮车行走，飞轮也转起来，同时SK6812 RGB LED亮彩色灯，micro:bit上面的5×5 LED点阵屏显示图案![Img](./media/ab3.png)。

![Img](./media/cou14.png)

③ 按下micro:bit上面的按钮B且松开时，飞轮车停止，飞轮也停止，同时SK6812 RGB LED熄灭，micro:bit上面的5×5 LED点阵屏清屏。
