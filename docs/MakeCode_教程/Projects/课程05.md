...
使用一些乐高积木块、Microbit V2主板，舵机扩展板和2个乐高舵机等，来搭建一个飞轮车，通过Microbit V2主板上面的按钮A/B和代码编程来控制飞轮车运行。
...
flowchart TD
    ...
    EventBtnA --> BtnAAction[1\. SK6812 RGB LED亮彩色灯<br>2\. 5×5 LED点阵屏显示 “高兴” 图案<br>3\. 飞轮车行走，飞轮也转起来]
    BtnAAction --> IdleState

    EventBtnB --> BtnBAction[1\. SK6812 RGB LED熄灭<br>2\. 5×5 LED点阵屏清屏<br>3\. 飞轮车停止，飞轮也停止]
...
③ 按下micro:bit上面的按钮B且松开时，飞轮车停止，飞轮也停止，同时SK6812 RGB LED熄灭，micro:bit上面的5×5LED点阵屏清屏。
