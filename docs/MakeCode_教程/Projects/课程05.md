...
**前面360°乐高舵机和后面360°乐高舵机的接线**

| 前面360°乐高舵机 | 舵机扩展板引脚(SERVO2/P2) | micro:bit V2主板引脚 |
| :-------------: | :----------------------: | :-----------------: |
|       棕线      |           GND            |          G          |
|       红线      |           VCC            |          V          |
|      橙黄线     |          SIG(S)          |          P2         |

| 后面360°乐高舵机 | 舵机扩展板引脚(SERVO1/P1) | micro:bit V2主板引脚 |
| :-------------: | :----------------------: | :-----------------: |
|       棕线      |            GND           |           G         |
|       红线      |            VCC           |           V         |
|      橙黄线     |           SIG(S)         |           P1        |
...
单击下载代码: ![Img](./media/ABC12.png) [3_3_5_Flywheel_Bike](./Codes/3_3_5_Flywheel_Bike.hex)
...
按下micro:bit V2主板上面的按钮A且松开时，飞轮车行走，飞轮也转起来，同时SK6812 RGB LED亮彩色灯，micro:bit V2主板上面的5×5 LED点阵屏显示图案![Img](./media/ab3.png)
