...
使用一些乐高积木块、Microbit V2主板，舵机扩展板和1个乐高舵机等，来搭建一个雄鹰，通过Microbit V2主板上面的按钮A/B和代码编程来控制雄鹰翱翔。
...
flowchart TD
    ...
    EventBtnA --> BtnAAction[1\. SK6812 RGB LED亮红灯<br>2\. 5×5 LED点阵屏显示“高兴”图案<br>3\. 翅膀缓慢飞舞起来]
    BtnAAction --> IdleState

    EventBtnB --> BtnBAction[1\. SK6812 RGB LED亮绿色灯<br>2\. 5×5 LED点阵屏显示“奶牛”图案<br>3\. 翅膀快速飞舞起来]
    BtnBAction --> IdleState
    
    EventBtnAB --> BtnABAction[1\. SK6812 RGB LED熄灭<br>2\. 5×5 LED点阵屏清屏<br>3\. 翅膀停止飞舞]
...
② 按下micro:bit V2主板上面的按钮A且松开时，翅膀慢速飞舞起来，同时SK6812 RGB LED亮红灯，micro:bit V2主板上面的5×5 LED点阵屏显示图案![Img](./media/ab3.png)。

![Img](./media/cou21.png)

③ 按下micro:bit V2主板上面的按钮B且松开时，翅膀快速飞舞起来，同时SK6812 RGB LED亮橙黄灯，micro:bit V2主板上面的5×5 LED点阵屏显示图案![Img](./media/ab6.png)。
