...
<span style="color: rgb(255, 76, 65);">**特别注意：** if()条件中的阈值150，可以根据自己的实际情况加以修改的。</span>
...
单击下载代码: ![Img](./media/ABC12.png) [3_3_3_Voice_Controlled_Animal](./Codes/3_3_3_Voice_Controlled_Animal.hex)
