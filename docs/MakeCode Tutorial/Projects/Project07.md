...
Here we build a Ferris wheel with a Microbit V2 board, a servo expansion board, a 360° LEGO servo and some LEGO parts. We program to control the rotation of the Ferris wheel through the Microbit V2 button A and B.
...
Press button A on the micro:bit V2 board and then release it, the Ferris wheel starts to turn, the five SK6812 RGB LEDs emit colorful light, and the 5×5 LED matrix displays ![Img](./media/ab3.png).

Press button B on the micro:bit V2 board and then release it, the Ferris wheel stops, and the five SK6812 RGB LEDs and the 5×5 LED matrix matrix turn off.
