...
**<span style="color: rgb(255, 76, 65);">Tip 1:</span>** Download [the latest Micro:bit firmware -0255 .hex file](https://www.microbit.org/get-started/user-guide/firmware/). If you have a micro:bit V2 (with speaker and microphone), there are two possible versions of the firmware; V2.00 and V2.20/2.21. Please select the firmware appropriate to your board.

![Img](./media/326.png)

**<span style="color: rgb(255, 76, 65);">Tip 2:</span>** We also provide you with the latest Micro:bit firmware -0255 .hex file: [Micro:bit_Firmware](./Microbit_Firmware.7z).
...
①. Disconnect the USB cable and battery pack from the micro:bit V2.

②. Hold the reset button at the back of the micro:bit and plug the USB cable into the micro:bit V2 and your computer. You should see a drive appear in your file manager called **MAINTENANCE** (instead of MICROBIT) and the yellow LED indicator on the back should light up.
