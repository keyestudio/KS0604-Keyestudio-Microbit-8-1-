...
**<span style="color: rgb(255, 76, 65);">Tip 1:</span>** Click to download <u>[the latest Micro:bit firmware -0257 .hex file](https://www.microbit.org/get-started/user-guide/firmware/)</u>. If you have a micro:bit V2 board (with speaker and microphone), there are two possible versions of the firmware; V2.00 and V2.20/2.21. Please select the firmware appropriate to your board.
...
If the reset button is pressed while powering up the micro:bit V2 board (even after you loaded the .hex file), the micro:bit will go into maintenance mode. (**<span style="color: rgb(255, 76, 65);">Common mistakes made by beginners</span>**)
...
①. Disconnect the microUSB cable and battery pack from the micro:bit V2 board.

②. Hold the reset button at the back of the micro:bit V2 board, and then plug the USB cable into the micro:bit V2 board and your computer. You should see a drive appear in your file manager called **MAINTENANCE** (instead of MICROBIT) and the yellow LED indicator on the back should light up.

![Img](./media/A51.png)

![Img](./media/maintenance.gif)

③. Click to download <u>[firmware .hex file](https://microbit.org/guide/firmware/)</u> appropriate for your version of the micro:bit V2 board. <span style="color: rgb(255, 76, 65);">Here is Firmware for V2.20_V2.21.</span>
