...
- **<span style="color: rgb(255, 76, 65);">Note:</span>** The SK6812 RGB LED and SERVO mode are multiplexed. Please switch to the corresponding mode according to your need.
...
- Insert 4 new AAA batteries, paying attention to the correct polarity.
