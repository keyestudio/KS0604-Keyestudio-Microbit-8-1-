...
(2). 按照下图操作，直接将下载好的最新固件-Firmware for V2.20_V2.21 (<span style="color: rgb(255, 76, 65);">特别提醒：根据Micro:bit主板的型号选择不同的固件，这里是以固件-Firmware for V2.20_V2.21为例。</span>) 十六进制文件拖入到  “**MAINTENANCE**” 驱动器，即可将Micro:bit主板恢复到正常模式。
